...
<input type="hidden" id="u_id" name="u_id" value="<?php echo $u_id?>">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">Blocked Users</a></li>
    ...
    <section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <div class="members">
              <h1 class="page-header">Blocked Users</h1>
	...
	async function showblocked(){
				const response = await fetch('http://localhost/facebook/php/showblocked.php?u_id='+$('#u_id').val());
				if(!response.ok){
		...
		for (var i = 0; i < data.length; i++){
			var row = `<div class="row member-row">
						   ...
						   <div class="col-md-3">
							...
							<div class="col-md-3">
							  <p><a class="btn btn-danger btn-block"><i class="fa fa-ban"></i>Blocked</a></p>
							</div>
						
							<div class="col-md-3">
							  <p><a id="unblock" data-id=${data[i].id} class="btn btn-primary btn-block"><i class="fa fa-unlock"></i>Unblock</a></p>
							</div>
							<div class="col-md-3">
							  <p><a href="userprofile.php?f_id=${data[i].id}" class="btn btn-success btn-block"><i class="fa fa-user"></i>View Profile</a></p>
							</div>
...
$(document).on('click','#unblock',function(){
	...
	success: function(dataResult){
					...
					if(dataResult.statusCode==200){
						...
						var message = "You unblocked "+ffname+" "+flname+", you can send a friend request";
						$.ajax({
