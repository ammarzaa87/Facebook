...
<input type="hidden" id="u_id" name="u_id" value="<?php echo $u_id?>">
  ...
  <div class="container">
      <div id="content">
        <form class='form-inline'>
          <div class="input-group">
            <input type='text' id='search' class="form-control search-form"  placeholder="Search Facebook">
	...
	<script>
	async function showbysearch(){
				const response = await fetch('http://localhost/facebook/php/showbysearch.php?key='+$('#search').val()+'&u_id='+$('#u_id').val());
				if(!response.ok){
		...
		for (var i = 0; i < data.length; i++){
			var row = `<div class="row member-row">
						   ...
						   <div class="col-md-3">
							...
							<div class="col-md-3">
							  <p><a id="add" data-id=${data[i].id} class="btn btn-success btn-block"><i class="fa fa-user-plus"></i> Add Friend</a></p>
							</div>
						
							<div class="col-md-3">
							  <p><a href="userprofile.php?f_id=${data[i].id}" class="btn btn-primary btn-block"><i class="fa fa-user"></i> View Profile</a></p>
							</div>
							<div class="col-md-3">
...
$(document).ready(function(){
	$(document).on('click','#search-this',function(){
		$('#myTable').empty();
		$( document ).ready(function() {
...
$(document).on('click','#add',function(){
	...
	success: function(dataResult){
					...
					if(dataResult.statusCode==200){
						...
						var message = fname+" "+lname+" sent you a friend request";
						$.ajax({
...
$(document).on('click','#block',function(){
	...
	success: function(dataResult){
					...
					if(dataResult.statusCode==200){
						var fname = dataResult.fname;
						var lname= dataResult.lname;
						var message = "You Blocked "+fname+" "+lname;
						$('#myTable').empty();
						$( document ).ready(function() {
								showbysearch().then(results => {
									buildTable(results);
