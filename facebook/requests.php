...
<input type="hidden" id="u_id" name="u_id" value="<?php echo $u_id?>">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
			...
			<li class="active"><a href="#">Friend Requests</a></li>
	...
	async function showrequests(){
				const response = await fetch('http://localhost/facebook/php/showrequests.php?u_id='+$('#u_id').val());
				if(!response.ok){
		...
		for (var i = 0; i < data.length; i++){
			var row = `<div class="row member-row">
						   ...
						   <div class="col-md-3">
							...
							<div class="col-md-3">
							  <p><a id="acc" data-id=${data[i].id} class="btn btn-success btn-block"><i class="fa fa-check"></i> Accept Request</a></p>
							</div>
						
							<div class="col-md-3">
							  <p><a id="dec" data-id=${data[i].id} class="btn btn-primary btn-block"><i class="fa fa-remove"></i>Decline request</a></p>
							</div>
							<div class="col-md-3">
...
$(document).on('click','#acc',function(){
	...
	success: function(dataResult){
					...
					if(dataResult.statusCode==200){
						...
						var message = fname+" "+lname+" accepted your friend request";
						$.ajax({
			...
			$.ajax({
				...
				data: {
					user_id:u_id,
					message: "You accepted "+ffname+" "+flname+" request",
...
$(document).on('click','#block',function(){
	...
	success: function(dataResult){
					...
					if(dataResult.statusCode==200){
						var fname = dataResult.fname;
						var lname= dataResult.lname;
						var message = "You Blocked "+fname+" "+lname+", the request is canceled";
						$('#myTable').empty();
						$( document ).ready(function() {
								showrequests().then(results => {
...
$(document).on('click','#dec',function(){
	...
	success: function(dataResult){
					...
					if(dataResult.statusCode==200){
						var ffname = dataResult.ffname;
						var flname= dataResult.flname;
						var message = "You declined "+ffname+" "+flname+" request";
						$.ajax({
				url: "php/addnotification.php",
				type: "POST",
				data: {
